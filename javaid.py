    ...
    def handlePath(self, path):
        ...
        for d in dirs:
            ...
            if os.path.isfile(subpath):
                if os.path.splitext(subpath)[1] == '.java' or os.path.splitext(subpath)[1] == '.xml' or os.path.splitext(subpath)[1] == '.jsp' or os.path.splitext(subpath)[1] == '.jar' or os.path.splitext(subpath)[1] == '.class':
